<template>
  <div class="container">
    <div class="col-sm-10">
      <h1 class="taskmanager">Задачи</h1>
      <h5 class="task-info">Колличество задач: {{ totalTasks }}</h5>
      <h5 class="task-info">Невыполненных: {{ uncompletedTasks }}</h5>
      ...
      <table class="table table-dark table-stripped table-hover">
        ...
        <tbody>
          <tr v-for="(todo, index) in todos" :key="index"
            ...
            <td class="task-info">{{ todo.description }}</td>
